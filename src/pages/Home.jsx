        ...
        >
          {products.map((product, index) => (
            <SwiperSlide
              ...
              <Link to={`/categories/jelly/${index}`} className='max-w-[250px] h-[250px] overflow-hidden'>
              ...
              <div className=''>
                ...
                <h1 className={`${product.content[0].type === "energy package" ? 'text-xl' : 'text-2xl'} sm:text-[22px] lg:text-3xl text-white font-semibold -mt-2 ml-2 mb-5 px-5 py-2 bg-[#804896] w-fit rounded-tl-[34px] rounded-br-[34px] capitalize`}>{t(product.content[0].type)}</h1>
              </div>
